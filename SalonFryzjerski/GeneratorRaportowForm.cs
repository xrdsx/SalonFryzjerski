...
namespace SalonFryzjerski
{
    public partial class GeneratorRaportowForm : Form
    {
        ...
        {
            DateTime dataOd = dateTimePicker1.Value.Date;
            DateTime dataDo = new DateTime(dateTimePicker2.Value.Year, dateTimePicker2.Value.Month, DateTime.DaysInMonth(dateTimePicker2.Value.Year, dateTimePicker2.Value.Month));
